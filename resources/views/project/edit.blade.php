...
<div class="container-fluid">
    <nav class="my-4" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('project.detail', $project) }}">{{ $project->project_name }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">（編集）</li>
        </ol>
    </nav>
    <form enctype="multipart/form-data" class="mt-5 entry-form" action="{{ route('project.edit.put', $project) }}" method="post">
        @method('PUT')
        @csrf
        @if ($errors->any())
